...
import { addEmailValidationHash } from '../models/user-queries.js'
...
export const getUrlResetLink = async email => {
  ...
  return `${config.publicUrl}/utilisateurs/reinitialisation-lien?email=${encodeURIComponent(
    email,
